...
const TRANSLATIONS = {
    es: {
        ...
        editTextTitle: 'Editor de Texto PDF',
        editTextSubtitle: 'Carga un PDF, hace clic en cualquier texto para editarlo directamente sobre la previsualización, y descargá el resultado.',
        editTextPreviewTitle: 'Previsualización del documento',
        editTextPreviewSubtitle: 'Hacé clic sobre cualquier texto para editarlo directamente.',
        pageNavPrev: 'Anterior',
        pageNavNext: 'Siguiente',
        pageNavOf: 'de',
        downloadEditedPdf: 'Descargar PDF editado',
        editTextZoomIn: 'Acercar',
        editTextZoomOut: 'Alejar',
        editTextPendingEdits: 'cambios pendientes',
        editTextNoChanges: 'No hay cambios para guardar.',
    },
    en: {
        appTitle: 'PDF Editor Platform',
        ...
        editTextTitle: 'PDF Text Editor',
        editTextSubtitle: 'Load a PDF, click on any text to edit it directly on the preview, and download the result.',
        editTextPreviewTitle: 'Document preview',
        editTextPreviewSubtitle: 'Click on any text to edit it directly.',
        pageNavPrev: 'Previous',
        pageNavNext: 'Next',
        pageNavOf: 'of',
        downloadEditedPdf: 'Download edited PDF',
        editTextZoomIn: 'Zoom in',
        editTextZoomOut: 'Zoom out',
        editTextPendingEdits: 'pending changes',
        editTextNoChanges: 'No changes to save.',
    },
} as const;
